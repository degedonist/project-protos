...
const (
	...
	TaskService_ListTasksByUserId_FullMethodName = "/task.TaskService/ListTasksByUserId"
)
...
type TaskServiceClient interface {
	...
	ListTasksByUserId(ctx context.Context, in *ListTasksByUserIdRequest, opts ...grpc.CallOption) (*ListTasksByUserIdResponse, error)
}
...
func (c *taskServiceClient) ListTasksByUserId(ctx context.Context, in *ListTasksByUserIdRequest, opts ...grpc.CallOption) (*ListTasksByUserIdResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListTasksByUserIdResponse)
	err := c.cc.Invoke(ctx, TaskService_ListTasksByUserId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TaskServiceServer interface {
	...
	ListTasksByUserId(context.Context, *ListTasksByUserIdRequest) (*ListTasksByUserIdResponse, error)
...
func (UnimplementedTaskServiceServer) ListTasksByUserId(context.Context, *ListTasksByUserIdRequest) (*ListTasksByUserIdResponse, error) {
