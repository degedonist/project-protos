...
type CreateTaskRequest struct {
	...
	UseId         string                 `protobuf:"bytes,2,opt,name=useId,proto3" json:"useId,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateTaskRequest) GetUseId() string {
	if x != nil {
		return x.UseId
	}
	return ""
...
const file_task_task_proto_rawDesc = "" +
	...
	"\x05useId\x18\x02 \x01(\tR\x05useId\"4\n" +
	"\x12CreateTaskResponse\x12\x1e\n" +
	"\x04task\x18\x01 \x01(\v2\n" +
	".task.TaskR\x04task\"Q\n" +
	...
	"\tListTasks\x12\x16.task.ListTasksRequest\x1a\x17.task.ListTasksResponse\x12T\n" +
	"\x11ListTasksByUserId\x12\x1e.task.ListTasksByUserIdRequest\x1a\x1f.task.ListTasksByUserIdResponseB1Z/github.com/degedonist/project-protos/proto/taskb\x06proto3"
...
var file_task_task_proto_goTypes = []any{
	...
	(*ListTasksByUserIdRequest)(nil),  // 11: task.ListTasksByUserIdRequest
	(*ListTasksByUserIdResponse)(nil), // 12: task.ListTasksByUserIdResponse
}
var file_task_task_proto_depIdxs = []int32{
	...
	0,  // 4: task.ListTasksByUserIdResponse.tasks:type_name -> task.Task
	...
	11, // 10: task.TaskService.ListTasksByUserId:input_type -> task.ListTasksByUserIdRequest
	...
	12, // 16: task.TaskService.ListTasksByUserId:output_type -> task.ListTasksByUserIdResponse
